...
export default function Signup() {
    ...
    const [form, setForm] = useState({
        user: '', name: '', email: '', password: '', github_handle: ''
    });
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
            <div className="w-full max-w-sm">
                ...
                <Paper elevation={0} sx={{ border: '1px solid #f3f4f6', borderRadius: 3, p: 4 }}>
                    <h2 className="text-base font-medium text-gray-900 mb-6">Create account</h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full flex items-center justify-center gap-2 py-2.5 px-4 bg-indigo-600 text-white text-sm rounded-lg hover:bg-indigo-700 transition-colors disabled:opacity-60"
                        >
                            {loading
